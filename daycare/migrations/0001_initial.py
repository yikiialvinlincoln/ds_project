    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount_due', models.DecimalField(blank=True, decimal_places=1, max_digits=15)),
                ('paid_amount', models.DecimalField(decimal_places=1, max_digits=15)),
                ('balance_left', models.DecimalField(blank=True, decimal_places=1, default=0, max_digits=15)),
            ],
        ),
        migrations.CreateModel(
            name='Doll_type',
